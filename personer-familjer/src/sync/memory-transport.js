...
import { batchPath, validateBatch } from './batch.js?v=2026-08-01-10';
import { CursorResetError } from './errors.js?v=2026-08-01-10';
...
export class MemoryRemoteTransport {
  constructor({ id = 'memory', pageSize = 100, opsRoot = '/matrikel/ops' } = {}) {
    this.id = id;
