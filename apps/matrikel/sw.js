const CACHE = 'korpholmen-matrikel-2026-08-04-personmaster-1';
...
const SHELL = [
  './',
  './index.html',
  '../app-switcher.css?v=2026-08-04-ui-2',
  './styles.css?v=2026-08-04-ui-1',
  './manifest.webmanifest',
  './icons/icon.svg',
  './src/app.js?v=2026-08-04-personmaster-1',
  FAMILY_CORE,
