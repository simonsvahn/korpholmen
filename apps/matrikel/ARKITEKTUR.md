# Arkitektur för Matrikel

Matrikeln är den tidsbundna medlemsmastern för Korpholmens
...
Matrikeln ska kunna svara på frågor som:
...
år, period, ägare, namnhistorik och källor utan att göra Matrikeln till
båtmaster.
...
- Ett verkligt namnbyte kan lagras som `name-change-candidate` i
  Matrikeln, men `writes_to_person_master` är `false` tills uppgiften har
  prövats i Matrikel.
